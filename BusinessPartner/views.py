...
from .serializers import BusinessPartnerBuyerSerializer, BusinessPartnerCraftsmanSerializer, BusinessPartnerKYCSerializer
from rest_framework.permissions import IsAuthenticated
...
class BuyerListView(ListAPIView):
    ...
    serializer_class = BusinessPartnerBuyerSerializer
...
class CraftsmanListView(ListAPIView):
    ...
    serializer_class = BusinessPartnerCraftsmanSerializer

class BusinessPartnerBUYERView(generics.GenericAPIView):
    """
...
class BusinessPartnerCRAFTSMANView(generics.GenericAPIView):
    """
    API for BusinessPartner:
    - GET: Retrieve all Business Partners or filter by `bp_code`.
    - POST: Create a new Business Partner.
...
class BuyerCraftsmanListView(ListAPIView):
...
class BusinessPartnerUpdateView(generics.GenericAPIView):
    """
    API for a single Business Partner:
    - GET: Retrieve a Business Partner by bp_code.
    - PUT: Update a Business Partner.
