...
from .views import BusinessPartnerBUYERView, BusinessPartnerCRAFTSMANView, BuyerCraftsmanListView, BusinessPartnerDetailView, BusinessPartnerUpdateView, BusinessPartnerKYCView, BusinessPartnerDeleteView, BusinessPartnerKYCDetailView, BusinessPartnerKycFreeze, BusinessPartnerKycRevoke, BuyerListView, CraftsmanListView

urlpatterns = [
    path('BusinessPartner/BUYER/create', BusinessPartnerBUYERView.as_view(), name='BusinessPartner-create'), 
    path('BusinessPartner/CRAFTSMAN/create', BusinessPartnerCRAFTSMANView.as_view(), name='BusinessPartner-create'),
    path('BusinessPartner/list', BuyerCraftsmanListView.as_view(), name='BusinessPartner-list'), 
    path('BusinessPartner/detail/<str:bp_code>/', BusinessPartnerDetailView.as_view(), name='BusinessPartner-detail'), 
    path('BusinessPartner/update/<str:bp_code>/', BusinessPartnerUpdateView.as_view(), name='BusinessPartner-detail'), 
